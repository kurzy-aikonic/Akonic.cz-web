      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr,auto] lg:gap-12">
          ...
          <FadeIn delay={0.05} animateOnMount>
            <p className="mb-4 inline-flex max-w-full flex-wrap items-center justify-center gap-x-2 gap-y-1 rounded-full border border-slate-200 bg-white/80 px-4 py-2.5 text-xs font-medium uppercase tracking-[0.2em] text-slate-600 backdrop-blur sm:justify-start">
          ...
          <FadeIn delay={0.18} animateOnMount>
            <div className="mt-4 space-y-3 text-lg text-slate-700 md:text-xl">
              ...
              <p className="mt-4 pt-4 border-t border-slate-200/70 text-base leading-snug text-slate-600 md:text-lg">
